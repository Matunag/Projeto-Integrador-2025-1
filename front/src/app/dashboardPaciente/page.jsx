...
export default function DashboardPaciente() {
  return (
        <div className="w-full">
            ...
            <div className="w-[90%] mx-auto h-screen flex flex-col items-center px-2 mt-10 gap-7">
              ...
              <div className="flex justify-between w-full gap-x-6">
                ...
                <button className="bg-[#FFF1F1] w-[90%] h-[140px] xs:h-[160px] rounded-xl text-2xl flex flex-col items-start justify-start px-1 py-3 shadow-md shadow-blue-500">
